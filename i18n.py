...
_STR = {
    "ru": {
        ...
        "s_every": "каждые {n}ч",
        "s_rem_mode": "🧠 Тип напоминаний: {v}",
        "rem_mode_interval": "интервальные",
        "rem_mode_smart": "умные",
        "s_meal_times": "🍽 Время приёмов: {v}",
        "rem_auto": "авто",
        "meal_times_prompt": ("Во сколько ты обычно ешь? Напиши часы через запятую "
                              "(напр. `8, 13, 19`). Или напиши «авто» — подберу по твоим записям."),
        "meal_times_set": "✅ Время приёмов обновлено: {v}. Буду напоминать к этим часам.",
        "meal_times_auto": "✅ Включил авто-подбор времени по твоим записям.",
        "meal_times_bad": "Не понял. Напиши часы через запятую, напр. `8, 13, 19`, или «авто».",
        "smart_on_note": ("🧠 Умные напоминания включены. Я подберу типичное время твоих приёмов "
                          "по истории; пока данных мало — поработаю как обычные. Время можно задать вручную."),
        "smart_reminder": "🍽 Обычно ты ешь примерно сейчас — не забудь записать приём пищи 📷",
        "s_mode": "🏃 Режим: {v}",
        "s_profile": "👤 Профиль",
    ...
    "en": {
        ...
        "s_every": "every {n}h",
        "s_rem_mode": "🧠 Reminder type: {v}",
        "rem_mode_interval": "interval",
        "rem_mode_smart": "smart",
        "s_meal_times": "🍽 Meal times: {v}",
        "rem_auto": "auto",
        "meal_times_prompt": ("When do you usually eat? Send hours separated by commas "
                              "(e.g. `8, 13, 19`). Or type “auto” — I'll learn from your logs."),
        "meal_times_set": "✅ Meal times updated: {v}. I'll remind you around then.",
        "meal_times_auto": "✅ Auto-detection of meal times from your logs is on.",
        "meal_times_bad": "Didn't get it. Send hours like `8, 13, 19`, or “auto”.",
        "smart_on_note": ("🧠 Smart reminders on. I'll learn your usual meal times from history; "
                          "until there's enough data I'll work like the regular ones. You can also set times manually."),
        "smart_reminder": "🍽 You usually eat around now — don't forget to log your meal 📷",
        "s_mode": "🏃 Mode: {v}",
        "s_profile": "👤 Profile",
        "s_reset": "🗑 Start over",
        "on": "🔔 on", "off": "🔕 off",
